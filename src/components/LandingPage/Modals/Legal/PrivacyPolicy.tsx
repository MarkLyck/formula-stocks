...
const PrivacyPolicyModal = ({ visible, onClose }: PrivacyPolicyModalProps) => {
  return (
    ...
    >
      <Paragraph>
        When you register an account on our website or application, as part of the process, we collect the personal
        information you give us such as your name, country and email address.
        <br />
        <br />
        When you browse our website or application, we also automatically receive your computer’s internet protocol (IP)
        address in order to provide us with information that helps us learn about your browser and operating system.
        <br />
        <br />
        Email marketing (if applicable): With your permission, we may send you emails about our website or application,
        new products and other updates.
      </Paragraph>

      <h3>Consent</h3>
      <Paragraph>
        When you provide us with personal information, when you register an account, complete a transaction, verify your
        credit card, place an order, arrange for a delivery or return a purchase or give us your information in any
        other way, we imply that you consent to our collecting it and using it for that specific reason only.
        <br />
        <br />
      ...
      <h3>Payment</h3>
      <Paragraph>
        If you choose a direct payment gateway to complete your purchase, then FORMULA STOCKS stores your credit card
        ...
        <br />
        <br />
        PCI-DSS requirements help ensure the secure handling of credit card information by our website and its service
        providers.
      </Paragraph>
      ...
      <Paragraph>
        ...
        <br />
        <br />
        Once you leave our website or application or are redirected to a third-party website or application, you are no
      ...
      <Paragraph>
        ...
        clarifications will take effect immediately upon their posting on the website or application. If we make
      ...
      <Paragraph>
        ...
        complaint, or simply want more information contact our Privacy Compliance Officer at info@formulastocks.com
      </Paragraph>
